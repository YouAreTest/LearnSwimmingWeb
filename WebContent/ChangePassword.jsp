...
<body>
		...
		<div class="right">
			<form class="fillinformation" action="#" method="post">
				<ul class="information">
					<li><span>旧密码</span> <span class="password"><input
							type="password" size="20" id="userpassword" name="userpassword"
							maxlength="20" placeholder="请输入您的旧密码" value=""
							style="padding-left: 10px; width: -webkit-fill-available; background: none; border: none; outline: none; position: relative; top: -57px; left: 122px;"></span></li>

					<li><span>新密码</span> <span class="password"><input
							type="password" name="newpassword1" placeholder="请输入您的新密码"
							style="background: none; border: none; outline: none; position: absolute; top: 99px; left: 143px;"></span></li>

					<li><span>确定新密码</span> <span class="password"><input
							type="password" name="newpassword2" placeholder="请确认您的新密码"
							style="background: none; border: none; outline: none; position: absolute; top: 198px; left: 145px;"></span></li>
					<li><input type="reset" value="重置"
						style="width: 40%; background-color: #275262; border-bottom-left-radius: 10px; border: none; position: relative; left: -45px;
	/* top: -3px; */ color: wheat; font-weight: 600; letter-spacing: 15px;">
						<input type="submit" value="提交"
						style="width: 40%; background-color: #295261; border-bottom-right-radius: 10px; border: none; position: relative; left: 46px; color: wheat; top: -3; font-weight: 600; letter-spacing: 13px;"></li>
				</ul>
	...
	<div class="foot" style="top: 650px;">
	支持我们
	</div>
</body>
</html>