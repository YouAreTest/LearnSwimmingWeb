...
<body>
	...
	<div class="middle">
		...
		<div class="right">
			<ul class="information">
				<li><span>账号</span> <span class="userid"></span></li>
				<li><span>用户名</span> <span class="username"></span></li>
				<li><span>性别</span> <span class="usersex"></span></li>
				<li><span>年龄</span> <span class="userage"></span></li>
	...
	<div class="foot" style="top: 703px;">
	支持我们
	</div>
</body>
</html>